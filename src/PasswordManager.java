...
public class PasswordManager implements ActionListener {
    ...
    public static void ContainerGUI(Container conn) {
        ...
        conn.setBackground(Color.getHSBColor(0.0f, 0.0f, 0.0f));
        conn.setLayout(null);
    }
    ...
    PasswordManager() {
        frame = new JFrame("Password Management System");
        ...
        PassSearchBtn.addActionListener(e -> extracted2(e));
        // ----------------------------------------------------------------------------------------------------------------------
        // deleting password
        ...
        PassDeleteBtn.addActionListener(e -> extracted(e));

    }

    private void extracted2(ActionEvent e) {
    ...
    private void extracted(ActionEvent e) {
